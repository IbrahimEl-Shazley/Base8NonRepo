...
using BaseProject.Services.DashBoard.Contract.AdminInterfaces;
using Microsoft.AspNetCore.Identity;
using Microsoft.EntityFrameworkCore;

namespace BaseProject.Services.DashBoard.Implementation.AdminImplementation
{
    public class AdminServices : IAdminServices
    {
        ...
        {
            var users = await _userManager.Users.Where(u => u.AccountType == UserType.Admin).ToListAsync();
        ...
        {
            return await _userManager.Users.Where(u => u.AccountType == UserType.Admin).ToListAsync();
        }
