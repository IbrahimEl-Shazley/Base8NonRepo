...
using BaseProject.Services.Mapping;
using Microsoft.AspNetCore.Identity;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Configuration;
using System.IdentityModel.Tokens.Jwt;
using NotifyModel = BaseProject.Domain.Common.Helpers.Notifications.NotifyModel;
    ...
    public class UserServices : IUserServices
    {
        ...
        public async Task<UserInfoDto> GetUserInfo(string userId, string token)
        {
            var userInfoDto = await _context.Users
                .Where(x => x.Id == userId && x.AccountType == UserType.Client)
                .AsQueryable()
                .AsNoTracking()
