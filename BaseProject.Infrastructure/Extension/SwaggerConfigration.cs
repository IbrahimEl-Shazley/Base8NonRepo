...
namespace BaseProject.Infrastructure.Extension
{
    public class SwaggerConfigration : IConfigureOptions<SwaggerGenOptions>
    {
        public void Configure(SwaggerGenOptions c)
        {
            ...
            string xmlPath1 = Path.Combine(Environment.CurrentDirectory, "BaseProject.Services.xml");
            string xmlPath2 = Path.Combine(Environment.CurrentDirectory, "BaseProject.xml");
