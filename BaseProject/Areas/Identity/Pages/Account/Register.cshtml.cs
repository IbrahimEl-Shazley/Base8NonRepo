    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationDbUser { UserName = Input.Email, Email = Input.Email, AccountType = UserType.Admin, ProfilePicture = uniqueFileName,  FullName = Input.Email, IsActive = true, IsCodeActivated = true };
