...
namespace BaseProject.Domain.Common.Helpers
{
    public class Helper : IHelper
    {
        ...
        public static string getFileTranslate(Lang.Translate lang, string key)
        {
            ...
            //var folderDetails = Path.Combine(Directory.GetCurrentDirectory(), $"..\\BaseProject.Domain\\Common\\Translate.json");
            ...
            if (translateFolderPath == null)
            {
                ...
                {
                    translateFolderPath = Path.Combine(Directory.GetCurrentDirectory(), $"..\\BaseProject.Domain\\Common\\Translate.json");
                    File.ReadAllText(translateFolderPath);
                }
            }
